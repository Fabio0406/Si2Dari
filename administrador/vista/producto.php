...
<a href="../controles/agregarproducto.php" class="btn btn-danger" class="button">AGREGAR</a>
<a href="../controles/eliminarproducto.php" class="btn btn-danger" class="button">ELIMINAR</a>
</div>
            </div>
            <div>
